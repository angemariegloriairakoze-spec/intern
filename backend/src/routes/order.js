 ...
 *     description: Returns a list of orders placed by the authenticated customer, including full seller and product details (no user IDs)
 *     tags: [Orders]
 *     security:
 *       - bearerAuth: []
 *     responses:
 *       200:
 *         description: Successfully retrieved customer's orders
 *         content:
 *           application/json:
 *             schema:
 *               type: array
